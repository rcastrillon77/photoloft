...
function showBookingConfirmationPopup() {
  ...
  document.getElementById("confirm-popup-paragraph").textContent = `Your booking has been confirmed for <strong>${dateStr}</strong> from <strong>${startTimeStr}</strong> to <strong>${endTimeStr}</strong>.<br><br>Please familiarize yourself with the rules and instructions on this page.`;
  openPopup();
  showPopupById("confirmation-popup");
  triggerConfetti();
}
